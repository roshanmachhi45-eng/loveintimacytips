...
export default function Home() {
  ...
  return (
    <>
      <Seo
        title="LoveIntimacyTips — Personalized Intimacy & Wellness Guide for Couples"
        description="Discover your compatibility score and get personalized intimacy tips, position recommendations, and relationship guidance tailored to you and your partner."
        path="/"
      />
