...
const sections = [
  {
    ...
    paragraphs: [
      'LoveIntimacyTips does not store any personal information you enter into the compatibility calculator. All inputs — names, age, height, body type, and experience level — remain in your browser session and are discarded when you close the page.',
...
export default function PrivacyPolicy() {
  return (
    <>
      <Seo
        title="Privacy Policy — LoveIntimacyTips"
        description="Read our privacy policy to understand how LoveIntimacyTips handles data collection, cookies, analytics, and your GDPR rights."
        path="/privacy-policy"
      />
      <PageLayout
