...
const sections = [
  ...
  {
    icon: Cookie,
    title: 'Cookies and Advertising Analytics',
    paragraphs: [
      'We use simple cookies to ensure our website loads fast and runs smoothly on your phone or computer browser. These cookies simply remember minor framework settings so you get a smooth reading flow every time you return.',
      'Google as a third party vendor uses cookies to serve ads on our site. Google use of advertising cookies enables it and its partners to serve ads to our users based on their visit to Loveons or other sites on the Internet. You can easily turn off cookies through your own web browser anytime you like though it might make a few visual interactive features load a little slower.'
    ],
  },
  {
    icon: BarChart2,
  ...
  {
    icon: UserCheck,
    title: 'Your Simple Privacy Choices and Contact',
    paragraphs: [
      'Your data is entirely in your hands. You can choose not to share anything personal with us at any time. If you have previously dropped us an email and want us to clear out that conversation history from our inbox you can easily drop a quick message to our team at contact.loveons@gmail.com and we will handle it for you right away.'
    ],
  },
  {
    icon: HelpCircle,
    ...
    paragraphs: [
      'We partner only with safe industry standard modern web systems for secure cloud hosting image optimization and analytics tracking. We absolutely do not sell or trade or distribute any of your personal details to outside marketing companies or ad networks. Your time spent here remains private and secure.'
    ],
  },
];
