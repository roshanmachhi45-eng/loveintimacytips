...
const CONTACT_EMAIL = 'rocksymac0@gmail.com';
...
export default function Contact() {
  ...
  return (
    <>
      <Seo
        title="Contact Us — LoveIntimacyTips"
        description="Get in touch with the LoveIntimacyTips team. Send us your questions, feedback, or suggestions about our intimacy and wellness tools."
        path="/contact"
      />
      <PageLayout
        title="Contact Us"
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm font-semibold text-gray-700">{CONTACT_EMAIL}</p>
            </div>
          </a>
          ...
          {sent ? (
            <div className="flex flex-col items-center text-center py-8 fade-in">
              ...
              <h2 className="font-display text-lg font-bold text-gray-800 mb-1">Message Sent!</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="name" className="block text-xs font-semibold text-rose-500 uppercase tracking-wider mb-1">
                  Your Name
                </label>
              ...
              <div>
                <label htmlFor="email" className="block text-xs font-semibold text-rose-500 uppercase tracking-wider mb-1">
                  Your Email
                </label>
                <div className="relative">
              ...
              <div>
                <label htmlFor="message" className="block text-xs font-semibold text-rose-500 uppercase tracking-wider mb-1">
                  Your Message
                </label>
                <div className="relative">
              ...
              <button
                type="submit"
                className="w-full py-3.5 rounded-2xl shimmer-btn text-white font-semibold text-sm shadow-lg shadow-rose-200 hover:shadow-rose-300 active:scale-[0.98] transition-all flex items-center justify-center gap-2"
              >
