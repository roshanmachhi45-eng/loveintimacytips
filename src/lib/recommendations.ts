import { getRandomTips, type TipItem } from './tips';
...
const imagePool: ResultImage[] = [
  ...
  { url: 'https://images.pexels.com/photos/1024997/pexels-photo-1024997.jpeg?auto=compress&cs=tinysrgb&w=600', caption: 'Affection & Care' },
